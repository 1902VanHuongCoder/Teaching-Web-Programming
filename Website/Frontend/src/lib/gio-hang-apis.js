...
export const layGioHangTheoNguoiDung = async (nguoiDungID) => {
    try {
        const response = await fetch(`${BASE_URL}/api/gio-hang/${nguoiDungID}`, {
            method: "GET",
            headers: {
...
export const themSanPhamVaoGioHang = async (nguoiDungID, sachID, soLuong, giaLucThem) => {
    try {
        const response = await fetch(`${BASE_URL}/api/gio-hang`, {
            method: "POST",
            headers: {
                "Content-Type": "application/json",
            },
...
export const capNhatSoLuongSanPham = async (chiTietGioHangID, soLuong) => {
    try {
        const response = await fetch(`${BASE_URL}/api/gio-hang/${chiTietGioHangID}`, {
            method: "PUT",
            headers: {
                "Content-Type": "application/json",
            },
...
export const xoaToanBoGioHang = async (nguoiDungID) => {
    try {
        const response = await fetch(`${BASE_URL}/api/gio-hang/toan-bo/${nguoiDungID}`, {
            method: "DELETE",
            headers: {
                "Content-Type": "application/json",
            },
...
export const demSoLuongSanPhamTrongGioHang = async (nguoiDungID) => {
    try {
        const response = await fetch(`${BASE_URL}/api/gio-hang/dem-so-luong/${nguoiDungID}`, {
            method: "GET",
            headers: {
                "Content-Type": "application/json",
            },
