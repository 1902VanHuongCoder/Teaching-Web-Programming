...
export const layTatCaPhuongThucGiaoHang = async () => {
    try {
        const response = await fetch(`${BASE_URL}/api/phuong-thuc-giao-hang`, {
            method: "GET",
            headers: {
...
export const capNhatPhuongThucGiaoHang = async (id, phuongThucGiaoHang) => {
    try {
        const response = await fetch(`${BASE_URL}/api/phuong-thuc-giao-hang/${id}`, {
            method: "PUT",
            headers: {
                "Content-Type": "application/json",
            },
...
export const xoaVinhVienPhuongThucGiaoHang = async (id) => {
    try {
        const response = await fetch(`${BASE_URL}/api/phuong-thuc-giao-hang/vinh-vien/${id}`, {
            method: "DELETE",
            headers: {
                "Content-Type": "application/json",
            },
...
export const kichHoatPhuongThucGiaoHang = async (id) => {
    try {
        const response = await fetch(`${BASE_URL}/api/phuong-thuc-giao-hang/kich-hoat/${id}`, {
            method: "PATCH",
            headers: {
                "Content-Type": "application/json",
            },
