...
const taiAnhLenCloud = async (fileBuffer, folder) => { 
    return new Promise((resolve, reject) => {  // Giúp tránh callback hell và tạo ra hàm bất đồng bộ 
...
export const xuLyTaiAnhLenCloud = async (req, res) => {
    try {
        ...
        const folder = "bookstore"; // Thư mục trên Cloudinary để lưu trữ hình ảnh
