    ...
    try {
        ...
        if (tenPhuongThuc) {
            const existingMethod = await PhuongThucGiaoHang.findOne({
                where: { 
                    tenPhuongThuc,
                    phuongThucGiaoHangID: { [Op.ne]: id } // Ngoại trừ chính nó, [Op.ne] nghĩa là "không bằng"
                }
            });
        ...
        await phuongThucGiaoHang.update({
            ...
            phiGiaoHang: phiGiaoHang !== undefined ? parseFloat(phiGiaoHang) : phuongThucGiaoHang.phiGiaoHang,
            thoiGianGiaoHang: thoiGianGiaoHang !== undefined ? thoiGianGiaoHang : phuongThucGiaoHang.thoiGianGiaoHang,
